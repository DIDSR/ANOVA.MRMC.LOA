...
* Different number of readers $J=3,4,…,10,K=100, \alpha_R=10, \sigma_C^2=1$
* Different number of cases  $K=50,60,…,150, J=5, \alpha_R=10, \sigma_C^2=1$
* Different reader and case variabilities  $(\alpha_R,\sigma_C^2)\in\{3,4,6,11,21\}\times\{0.1,0.2,0.4,\frac{2}{3},1\}, J=5, K=100$
